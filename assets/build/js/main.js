...
fetch(json_request_url + post_type + "s/" + post_id).then(function (data) {
  return data.json();
...
function loadNames(_x, _x2) {
  return _loadNames.apply(this, arguments);
}

function _loadNames() {
  _loadNames = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(post_id, post_type) {
    var url, response, names;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            url = json_request_url.concat(post_type, "s/", post_id);
            _context.next = 3;
            return fetch(url, {
              method: 'GET',
              headers: {
