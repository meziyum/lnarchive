...
class novel {
    ...
    private function register_novel() {
    ...
    private function get_novel_filters() {
    ...
    private function intialize_novel($post_ID, $post, $update) {
        if ($update) {
            return;
        }
    ...
    private function auto_novel($post_id) {
