...
const ReadingListItem: React.FC<ReadingListItemProps> = ({ID, progress, rating, status, title, showProgress=false, showRating=false, showStatus=false}: ReadingListItemProps) => {
    return (
        <>
